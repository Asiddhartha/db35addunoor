...
router.get('/detail', secured, jack_controllers.jack_view_one_Page);
/* GET create jack page */
router.get('/create', secured, jack_controllers.jack_create_Page);
/* GET update costume page */
router.get('/update', secured, jack_controllers.jack_update_Page);
/* GET delete jack page */
router.get('/delete', secured, jack_controllers.jack_delete_Page);
